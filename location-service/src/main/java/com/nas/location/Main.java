...
public class Main {
    ...
    public static void main(String[] args) {
        try {
            ...
            String IP = "196.89.204.54";

            if (Proxy.Open("/Users/anas/Downloads/mini-uber-microservice/location-service/src/main/resources/db/IP2PROXY-LITE-PX1.BIN", IP2Proxy.IOModes.IP2PROXY_MEMORY_MAPPED) == 0) {
